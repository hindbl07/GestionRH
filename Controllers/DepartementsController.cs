...
namespace GestionRH.Controllers
{
    public class DepartementsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Code")] Departement departement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Code")] Departement departement)
        {
